# -*- coding: utf-8 -*-
"""(2)DenseNet_Solo.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1foHDtCK8t5F2POaBCreHny2jLH_RAZvP
"""
...
# Freeze the parameters in the DenseNet201 model
for parameter in model_DenseNet201.parameters():
    parameter.requires_grad = False

# Get the number of input features for the classifier
num_features = model_DenseNet201.classifier.in_features

# Replace the classifier with a custom sequence of layers
...
print(f'model_DenseNet201 - Accuracy: {accuracy:.2f}, Precision: {precision:.2f}, Recall: {recall:.2f}, F1 Score: {f1:.2f}')
plot_confusion_matrix(cm, 'Confusion Matrix for model_DenseNet201')

torch.save(model_DenseNet201,'/content/drive/MyDrive/Models_Project2/model_DenseNet201.pth')